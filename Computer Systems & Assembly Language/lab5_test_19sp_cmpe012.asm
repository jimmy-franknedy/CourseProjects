...
.data
test_array_find_max: .word 1 2 3 0                   # test array before entering subroutine <---------<---------<--------- SAFE TO MODIFY
...
.data
test_array_print: .word 10 20 0           # array before entering subroutine <---------<---------<--------- SAFE TO MODIFY
