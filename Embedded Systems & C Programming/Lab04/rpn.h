...
enum rpn_error{
    RPN_NO_ERROR = 0,               // No Error                      (0) // TESTED
    RPN_ERROR_STACK_OVERFLOW,       // Stack can't push              (1) // TESTED
    RPN_ERROR_STACK_UNDERFLOW,      // Stack can't pull              (2)
    RPN_ERROR_INVALID_TOKEN,        // Invalid user input            (3) 
    RPN_ERROR_DIVIDE_BY_ZERO,       // Can't divive by 0             (4) // TESTED
    RPN_ERROR_TOO_FEW_ITEMS_REMAIN, // 0 items on stack upon return  (5) // TESTED
    RPN_ERROR_TOO_MANY_ITEMS_REMAIN // >1 items on stack upon return (6) // TESTED
};
